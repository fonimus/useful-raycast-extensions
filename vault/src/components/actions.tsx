...
export function Configuration() {
    return <ActionPanel.Section title="Configuration">
        <Action.Push
            icon={Icon.Cog} title={"Change namespace"}
...
export function Reload(props: { revalidate: () => Promise<void> }) {
    ...
    return <ActionPanel.Section title="Reload">
        <Action
            icon={Icon.RotateClockwise} title={"Reload"}
...
export function CopyToken() {
    return <Action.CopyToClipboard
        icon={Icon.CopyClipboard} title="Copy token"
...
export function OpenVault(props: { path?: string }) {
    ...
    return <Action.OpenInBrowser
        icon={Icon.Globe} title="Open in vault UI"
...
export function Root() {
    return <Action.Push
        icon={Icon.ArrowLeft} title="Go to root"
